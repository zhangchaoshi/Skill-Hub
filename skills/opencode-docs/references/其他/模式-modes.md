<!-- source: https://opencode.ai/docs/zh-cn/modes -->

[跳转到内容](模式-modes.md#_top)
...
## [内置模式](模式-modes.md#%E5%86%85%E7%BD%AE%E6%A8%A1%E5%BC%8F)

opencode 自带两种内置模式。

* * *

### [Build](模式-modes.md#build)

Build 是启用了所有工具的 **默认** 模式。这是进行开发工作的标准模式，你可以完全访问文件操作和系统命令。

* * *

### [Plan](模式-modes.md#plan)
...
## [切换](模式-modes.md#%E5%88%87%E6%8D%A2)

你可以在会话中使用 _Tab_ 键切换模式，或者使用你配置的 `switch_mode` 快捷键。

另请参阅： [格式化工具](https://opencode.ai/docs/formatters) 了解代码格式化配置的相关信息。

* * *

## [配置](模式-modes.md#%E9%85%8D%E7%BD%AE)

你可以自定义内置模式或通过配置创建自己的模式。模式可以通过两种方式进行配置：

### [JSON 配置](模式-modes.md#json-%E9%85%8D%E7%BD%AE)
...
### [Markdown 配置](模式-modes.md#markdown-%E9%85%8D%E7%BD%AE)
...
### [模型](模式-modes.md#%E6%A8%A1%E5%9E%8B)
...
### [温度](模式-modes.md#%E6%B8%A9%E5%BA%A6)
...
### [提示词](模式-modes.md#%E6%8F%90%E7%A4%BA%E8%AF%8D)
...
### [工具](模式-modes.md#%E5%B7%A5%E5%85%B7)
...
#### [可用工具](模式-modes.md#%E5%8F%AF%E7%94%A8%E5%B7%A5%E5%85%B7)
...
## [自定义模式](模式-modes.md#%E8%87%AA%E5%AE%9A%E4%B9%89%E6%A8%A1%E5%BC%8F)

你可以通过在配置中添加自定义模式来创建自己的模式。以下是两种方式的示例：

### [使用 JSON 配置](模式-modes.md#%E4%BD%BF%E7%94%A8-json-%E9%85%8D%E7%BD%AE)
...
### [使用 Markdown 文件](模式-modes.md#%E4%BD%BF%E7%94%A8-markdown-%E6%96%87%E4%BB%B6)
...
### [使用场景](模式-modes.md#%E4%BD%BF%E7%94%A8%E5%9C%BA%E6%99%AF)
