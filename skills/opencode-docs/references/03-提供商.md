...
OpenCode Zen 是由 OpenCode 团队提供的模型列表，这些模型已经过测试和验证，能够与 OpenCode 良好配合使用。 [了解更多](https://opencode.ai/docs/zen)。
...
OpenCode Zen 是由 OpenCode 团队提供的经过测试和验证的模型列表。 [了解更多](https://opencode.ai/docs/zen)。
...
- **apiKey**：使用 `env` 变量语法设置， [了解更多](https://opencode.ai/docs/config#env-vars)。
