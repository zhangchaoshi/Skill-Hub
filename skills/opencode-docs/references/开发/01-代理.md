...
OpenCode 配置中的模型 ID 使用 `provider/model-id` 格式。例如，如果您使用 [OpenCode Zen](https://opencode.ai/docs/zen)，则可以使用 `opencode/gpt-5.1-codex` 来表示 GPT 5.1 Codex。
...
[了解更多关于工具的信息](https://opencode.ai/docs/tools)。
...
[了解更多关于权限的信息](https://opencode.ai/docs/permissions)。
