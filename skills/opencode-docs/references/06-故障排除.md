<!-- source: https://opencode.ai/docs/zh-cn/troubleshooting -->

[跳转到内容](06-故障排除.md#_top)
...
## [日志](06-故障排除.md#%E6%97%A5%E5%BF%97)
...
## [存储](06-故障排除.md#%E5%AD%98%E5%82%A8)
...
## [桌面应用](06-故障排除.md#%E6%A1%8C%E9%9D%A2%E5%BA%94%E7%94%A8)

OpenCode Desktop 会在后台运行一个本地 OpenCode 服务器（即 `opencode-cli` 附属进程）。大多数问题是由插件异常、缓存损坏或错误的服务器设置引起的。

### [快速检查](06-故障排除.md#%E5%BF%AB%E9%80%9F%E6%A3%80%E6%9F%A5)
...
### [禁用插件](06-故障排除.md#%E7%A6%81%E7%94%A8%E6%8F%92%E4%BB%B6)

如果桌面应用在启动时崩溃、卡住或行为异常，请先禁用插件。

#### [检查全局配置](06-故障排除.md#%E6%A3%80%E6%9F%A5%E5%85%A8%E5%B1%80%E9%85%8D%E7%BD%AE)
...
#### [检查插件目录](06-故障排除.md#%E6%A3%80%E6%9F%A5%E6%8F%92%E4%BB%B6%E7%9B%AE%E5%BD%95)
...
### [清除缓存](06-故障排除.md#%E6%B8%85%E9%99%A4%E7%BC%93%E5%AD%98)
...
### [修复服务器连接问题](06-故障排除.md#%E4%BF%AE%E5%A4%8D%E6%9C%8D%E5%8A%A1%E5%99%A8%E8%BF%9E%E6%8E%A5%E9%97%AE%E9%A2%98)

OpenCode Desktop 可以启动自己的本地服务器（默认行为），也可以连接到你配置的服务器 URL。

如果你看到\*\*“Connection Failed”\*\*对话框（或应用始终停留在启动画面），请检查自定义服务器 URL。

#### [清除桌面默认服务器 URL](06-故障排除.md#%E6%B8%85%E9%99%A4%E6%A1%8C%E9%9D%A2%E9%BB%98%E8%AE%A4%E6%9C%8D%E5%8A%A1%E5%99%A8-url)

在主页面上，点击服务器名称（带有状态指示点）以打开服务器选择器。在 **默认服务器** 部分，点击 **清除**。

#### [从配置中移除 `server.port` / `server.hostname`](06-故障排除.md#%E4%BB%8E%E9%85%8D%E7%BD%AE%E4%B8%AD%E7%A7%BB%E9%99%A4-serverport--serverhostname)

如果你的 `opencode.json(c)` 包含 `server` 部分，请临时移除该部分并重新启动桌面应用。

#### [检查环境变量](06-故障排除.md#%E6%A3%80%E6%9F%A5%E7%8E%AF%E5%A2%83%E5%8F%98%E9%87%8F)
...
### [Linux: Wayland / X11 问题](06-故障排除.md#linux-wayland--x11-%E9%97%AE%E9%A2%98)
...
### [Windows: WebView2 运行时](06-故障排除.md#windows-webview2-%E8%BF%90%E8%A1%8C%E6%97%B6)

在 Windows 上，OpenCode Desktop 需要 Microsoft Edge **WebView2 Runtime**。如果应用打开后是空白窗口或无法启动，请安装或更新 WebView2 后重试。

* * *

### [Windows: 常见性能问题](06-故障排除.md#windows-%E5%B8%B8%E8%A7%81%E6%80%A7%E8%83%BD%E9%97%AE%E9%A2%98)

如果你在 Windows 上遇到性能缓慢、文件访问问题或终端问题，请尝试使用 [WSL (Windows Subsystem for Linux)](https://opencode.ai/docs/windows-wsl)。WSL 提供了一个 Linux 环境，能更好地与 OpenCode 的功能兼容。

* * *

### [通知不显示](06-故障排除.md#%E9%80%9A%E7%9F%A5%E4%B8%8D%E6%98%BE%E7%A4%BA)
...
### [重置桌面应用存储（最后手段）](06-故障排除.md#%E9%87%8D%E7%BD%AE%E6%A1%8C%E9%9D%A2%E5%BA%94%E7%94%A8%E5%AD%98%E5%82%A8%E6%9C%80%E5%90%8E%E6%89%8B%E6%AE%B5)
...
## [获取帮助](06-故障排除.md#%E8%8E%B7%E5%8F%96%E5%B8%AE%E5%8A%A9)
...
## [常见问题](06-故障排除.md#%E5%B8%B8%E8%A7%81%E9%97%AE%E9%A2%98)

以下是一些常见问题及其解决方法。

* * *

### [OpenCode 无法启动](06-故障排除.md#opencode-%E6%97%A0%E6%B3%95%E5%90%AF%E5%8A%A8)
...
### [身份验证问题](06-故障排除.md#%E8%BA%AB%E4%BB%BD%E9%AA%8C%E8%AF%81%E9%97%AE%E9%A2%98)
...
### [模型不可用](06-故障排除.md#%E6%A8%A1%E5%9E%8B%E4%B8%8D%E5%8F%AF%E7%94%A8)
...
### [ProviderInitError](06-故障排除.md#provideriniterror)

如果你遇到 ProviderInitError，很可能是配置无效或已损坏。

要解决此问题：

1. 首先，按照 [提供商指南](https://opencode.ai/docs/providers) 验证你的提供商是否已正确设置
...
### [AI\_APICallError 和提供商包问题](06-故障排除.md#ai_apicallerror-%E5%92%8C%E6%8F%90%E4%BE%9B%E5%95%86%E5%8C%85%E9%97%AE%E9%A2%98)
...
### [在 Linux 上复制/粘贴不可用](06-故障排除.md#%E5%9C%A8-linux-%E4%B8%8A%E5%A4%8D%E5%88%B6%E7%B2%98%E8%B4%B4%E4%B8%8D%E5%8F%AF%E7%94%A8)
