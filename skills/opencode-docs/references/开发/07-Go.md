...
## [工作原理](07-Go.md#%E5%B7%A5%E4%BD%9C%E5%8E%9F%E7%90%86)

OpenCode Go 的工作方式与 OpenCode 中的其他提供商一样。

1. 登录 **[OpenCode Zen](https://opencode.ai/auth)**，订阅 Go，并复制您的 API 密钥。
...
## [使用限制](07-Go.md#%E4%BD%BF%E7%94%A8%E9%99%90%E5%88%B6)
...
您可以在 **[console](https://opencode.ai/auth)** 中跟踪当前的用量。

随着我们从早期使用和反馈中学习，使用限制可能会发生变化。

* * *

### [定价](07-Go.md#%E5%AE%9A%E4%BB%B7)
...
### [超出限制的使用](07-Go.md#%E8%B6%85%E5%87%BA%E9%99%90%E5%88%B6%E7%9A%84%E4%BD%BF%E7%94%A8)

如果您的 Zen 余额中还有信用点数，您可以在控制台中启用 **Use balance**（使用余额）选项。启用后，当您达到使用限制时，Go 将回退到您的 Zen 余额，而不是阻止请求。

* * *

## [端点](07-Go.md#%E7%AB%AF%E7%82%B9)
...
OpenCode 配置中的 [model id](https://opencode.ai/docs/config/#models) 使用 `opencode-go/<model-id>` 格式。例如，对于 Kimi K2.5，您将在配置中使用 `opencode-go/kimi-k2.5`。

* * *

## [隐私](07-Go.md#%E9%9A%90%E7%A7%81)

该计划主要为国际用户设计，模型托管在美国、欧盟和新加坡，以确保稳定的全球访问。

如有任何问题，请 [联系我们](mailto:contact@anoma.ly)。

* * *

## [目标](07-Go.md#%E7%9B%AE%E6%A0%87)
