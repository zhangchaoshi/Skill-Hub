<!-- source: https://opencode.ai/docs/zh-cn/tools -->
...
工具允许 LLM 在您的代码库中执行操作。OpenCode 自带一组内置工具，您也可以通过 [自定义工具](https://opencode.ai/docs/custom-tools) 或 [MCP 服务器](https://opencode.ai/docs/mcp-servers) 来扩展它。

默认情况下，所有工具都是 **启用** 的，且无需权限即可运行。您可以通过 [权限](https://opencode.ai/docs/permissions) 来控制工具的行为。

* * *

## [配置](05-工具.md#%E9%85%8D%E7%BD%AE)
...
[了解更多](https://opencode.ai/docs/permissions) 关于配置权限的内容。

* * *

## [内置工具](05-工具.md#%E5%86%85%E7%BD%AE%E5%B7%A5%E5%85%B7)
...
### [lsp（实验性）](05-工具.md#lsp%E5%AE%9E%E9%AA%8C%E6%80%A7)
...
要配置项目可用的 LSP 服务器，请参阅 [LSP 服务器](https://opencode.ai/docs/lsp)。

* * *

### [patch](05-工具.md#patch)
...
### [skill](05-工具.md#skill)

加载一个 [技能](https://opencode.ai/docs/skills)（即 `SKILL.md` 文件）并在对话中返回其内容。
...
## [自定义工具](05-工具.md#%E8%87%AA%E5%AE%9A%E4%B9%89%E5%B7%A5%E5%85%B7)

自定义工具允许您定义 LLM 可以调用的自定义函数。这些函数在您的配置文件中定义，可以执行任意代码。

[了解更多](https://opencode.ai/docs/custom-tools) 关于创建自定义工具的内容。

* * *

## [MCP 服务器](05-工具.md#mcp-%E6%9C%8D%E5%8A%A1%E5%99%A8)

MCP（Model Context Protocol）服务器允许您集成外部工具和服务，包括数据库访问、API 集成和第三方服务。

[了解更多](https://opencode.ai/docs/mcp-servers) 关于配置 MCP 服务器的内容。

* * *

## [内部机制](05-工具.md#%E5%86%85%E9%83%A8%E6%9C%BA%E5%88%B6)
...
### [忽略模式](05-工具.md#%E5%BF%BD%E7%95%A5%E6%A8%A1%E5%BC%8F)
