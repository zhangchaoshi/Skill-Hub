<!-- source: https://opencode.ai/docs/zh-cn/config -->
...
### [优先级顺序](02-配置.md#%E4%BC%98%E5%85%88%E7%BA%A7%E9%A1%BA%E5%BA%8F)
...
### [项目级](02-配置.md#%E9%A1%B9%E7%9B%AE%E7%BA%A7)
...
### [自定义路径](02-配置.md#%E8%87%AA%E5%AE%9A%E4%B9%89%E8%B7%AF%E5%BE%84)
...
### [自定义目录](02-配置.md#%E8%87%AA%E5%AE%9A%E4%B9%89%E7%9B%AE%E5%BD%95)
...
[在此了解更多关于 TUI 的信息](https://opencode.ai/docs/tui)。

* * *

### [服务器](02-配置.md#%E6%9C%8D%E5%8A%A1%E5%99%A8)
...
[在此了解更多关于服务器的信息](https://opencode.ai/docs/server)。

* * *

### [工具](02-配置.md#%E5%B7%A5%E5%85%B7)
...
[在此了解更多关于工具的信息](https://opencode.ai/docs/tools)。

* * *

### [模型](02-配置.md#%E6%A8%A1%E5%9E%8B)
...
您还可以配置 [本地模型](https://opencode.ai/docs/models#local)。 [了解更多](https://opencode.ai/docs/models)。

* * *

#### [提供商特定选项](02-配置.md#%E6%8F%90%E4%BE%9B%E5%95%86%E7%89%B9%E5%AE%9A%E9%80%89%E9%A1%B9)

一些提供商支持除通用 `timeout` 和 `apiKey` 设置之外的额外配置选项。

##### [Amazon Bedrock](02-配置.md#amazon-bedrock)
...
[了解更多关于 Amazon Bedrock 配置的信息](https://opencode.ai/docs/providers#amazon-bedrock)。

* * *

### [主题](02-配置.md#%E4%B8%BB%E9%A2%98)
...
[在此了解更多](https://opencode.ai/docs/themes)。

* * *

### [代理](02-配置.md#%E4%BB%A3%E7%90%86)
...
您还可以使用 `~/.config/opencode/agents/` 或 `.opencode/agents/` 中的 Markdown 文件定义代理。 [在此了解更多](https://opencode.ai/docs/agents)。

* * *

### [默认代理](02-配置.md#%E9%BB%98%E8%AE%A4%E4%BB%A3%E7%90%86)
...
默认代理必须是主代理（不能是子代理）。可以是内置代理（如 `"build"` 或 `"plan"`），也可以是您定义的 [自定义代理](https://opencode.ai/docs/agents)。如果指定的代理不存在或是子代理，OpenCode 将回退到 `"build"` 并发出警告。

此设置适用于所有界面：TUI、CLI（`opencode run`）、桌面应用和 GitHub Action。

* * *

### [分享](02-配置.md#%E5%88%86%E4%BA%AB)

您可以通过 `share` 选项配置 [分享](https://opencode.ai/docs/share) 功能。
...
您还可以使用 `~/.config/opencode/commands/` 或 `.opencode/commands/` 中的 Markdown 文件定义命令。 [在此了解更多](https://opencode.ai/docs/commands)。

* * *

### [快捷键](02-配置.md#%E5%BF%AB%E6%8D%B7%E9%94%AE)
...
[在此了解更多](https://opencode.ai/docs/keybinds)。

* * *

### [自动更新](02-配置.md#%E8%87%AA%E5%8A%A8%E6%9B%B4%E6%96%B0)
...
### [格式化程序](02-配置.md#%E6%A0%BC%E5%BC%8F%E5%8C%96%E7%A8%8B%E5%BA%8F)
...
[在此了解更多关于格式化程序的信息](https://opencode.ai/docs/formatters)。

* * *

### [权限](02-配置.md#%E6%9D%83%E9%99%90)
...
[在此了解更多关于权限的信息](https://opencode.ai/docs/permissions)。

* * *

### [压缩](02-配置.md#%E5%8E%8B%E7%BC%A9)
...
### [文件监视器](02-配置.md#%E6%96%87%E4%BB%B6%E7%9B%91%E8%A7%86%E5%99%A8)
...
### [MCP 服务器](02-配置.md#mcp-%E6%9C%8D%E5%8A%A1%E5%99%A8)
...
[在此了解更多](https://opencode.ai/docs/mcp-servers)。

* * *

### [插件](02-配置.md#%E6%8F%92%E4%BB%B6)
...
该选项接受指令文件路径和 glob 模式的数组。 [在此了解更多关于规则的信息](https://opencode.ai/docs/rules)。

* * *

### [禁用提供商](02-配置.md#%E7%A6%81%E7%94%A8%E6%8F%90%E4%BE%9B%E5%95%86)
...
### [启用提供商](02-配置.md#%E5%90%AF%E7%94%A8%E6%8F%90%E4%BE%9B%E5%95%86)
...
### [实验性功能](02-配置.md#%E5%AE%9E%E9%AA%8C%E6%80%A7%E5%8A%9F%E8%83%BD)
...
## [变量](02-配置.md#%E5%8F%98%E9%87%8F)

您可以在配置文件中使用变量替换来引用环境变量和文件内容。

* * *

### [环境变量](02-配置.md#%E7%8E%AF%E5%A2%83%E5%8F%98%E9%87%8F)
